...
def plot_matter_setupMicroEsym( pname, models, band ):
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_matter_setupMicroEsym.py:")
    print(50*'-')
    #
    ...
    #
    plot_matter_setupMicroEsym( pname, models, bandEsym )
    #
    print(50*'-')
    print("Exit plot_matter_setupMicroEsym.py:")
    print(50*'-')
    #
