    ...
    def __init__(self, models=["Skyrme"]):
        ...
        for model in models:
            ...
            if dist.nep:
                ...
                if dist.Esat:
                    self.Esat.extend(dist.Esat)
                if dist.nsat:
                    self.nsat.extend(dist.nsat)
                if dist.Ksat:
                    self.Ksat.extend(dist.Ksat)
                if dist.Qsat:
                    self.Qsat.extend(dist.Qsat)
                if dist.Zsat:
                    self.Zsat.extend(dist.Zsat)
                if dist.Esym:
                    self.Esym.extend(dist.Esym)
                if dist.Lsym:
                    self.Lsym.extend(dist.Lsym)
                if dist.Ksym:
                    self.Ksym.extend(dist.Ksym)
                if dist.Qsym:
                    self.Qsym.extend(dist.Qsym)
                if dist.Zsym:
                    self.Zsym.extend(dist.Zsym)
                if dist.kappas:
                    self.kappas.extend(dist.kappas)
                if dist.kappav:
                    self.kappav.extend(dist.kappav)
                if dist.kappasym:
                    self.kappasym.extend(dist.kappasym)
                if dist.msat:
                    self.msat.extend(dist.msat)
                if dist.Dmsat:
                    self.Dmsat.extend(dist.Dmsat)
