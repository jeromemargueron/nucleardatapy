...
def plot_matter_setupPhenoEsym( pname, models, band ):
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_matter_setupPhenoEsym.py:")
    print(50*'-')
    #
    ...
    #
    plot_matter_setupPhenoEsym( pname, models, bandEsym )
    #
    print(50*'-')
    print("Exit plot_matter_setupPhenoEsym.py:")
    print(50*'-')
    #
