...
def plot_matter_setupFFGNuc( pname ):
    #
    ...
    ffg1 = nuda.matter.setupFFGNuc( den, delta1 )
    ffg1kf = nuda.matter.setupFFGNuc( denkf, delta1 )
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_matter_setupFFGNuc.py:")
    print(50*'-')
    #
    ...
    #
    pname = 'figs/plot_matter_setupFFGNuc.png'
    print(f'Plot name: {pname}')
    #
    plot_matter_setupFFGNuc( pname )
    #
    print(50*'-')
    print("Exit plot_matter_setupFFGNuc.py:")
    print(50*'-')
    #
