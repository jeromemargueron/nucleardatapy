...
def plot_corr_setupEsym( pname, constraints, Ksym ):
    #
    # plot
    #
    ...
    for constraint in constraints:
        #
        esym = nuda.corr.setupEsym( constraint = constraint , Ksym=Ksym )
        #
...
def main():
    #
    print(50*'-')
    print("Enter plot_corr_setupEsymDen.py:")
    print(50*'-')
    #
    ...
    for Ksym in Ksyms:
        #
        pname = 'figs/plot_corr_setupEsym_'+str(int(Ksym))+'.png'
        #
        plot_corr_setupEsym( pname, constraints, Ksym )
    #
    print(50*'-')
    print("Exit plot_corr_setupEsym.py:")
    print(50*'-')
    #
