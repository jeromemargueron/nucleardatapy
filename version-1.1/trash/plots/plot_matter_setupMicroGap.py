...
def plot_matter_setupMicro_nm_gap_1s0( pname, models ):
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_matter_setupMicroGap.py:")
    print(50*'-')
    #
    ...
    #
    plot_matter_setupMicro_nm_gap_1s0( pname, models )
    #
    # plot 3PF2 pairing gaps in NM
    #
    pname = 'figs/plot_matter_setupMicro_gap_3pf2_NM.png'
    #
    plot_matter_setupMicro_nm_gap_3pf2( pname, models )
    #
    print(50*'-')
    print("Exit plot_matter_setupMicroGap.py:")
    print(50*'-')
    #
