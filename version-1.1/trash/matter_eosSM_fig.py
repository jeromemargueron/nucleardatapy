...
def matter_eosSM_fig( pname, micro_mbs, pheno_models, band ):
    """
        ...
        for model in models:
            ...
            if micro.sm_pre is not None:
                ...
                if mb in mb_check:
                    ...
                    if micro.marker:
                        if micro.p_err:
                            axs[0].errorbar( esm.sm_e2v, micro.sm_pre, yerr=micro.sm_pre_err, marker=micro.marker, linestyle=lstyle, label=mb, errorevery=micro.every, color=nuda.param.col[kmb] )
                        else:
                        ...
                        if micro.p_err:
                            ...
                            axs[0].plot( micro.sm_e2v, esm.sm_pre, marker=esm.marker, linestyle=lstyle, label=mb, markevery=micro.every, color=nuda.param.col[kmb] )
            # end of model
        # end of mb
