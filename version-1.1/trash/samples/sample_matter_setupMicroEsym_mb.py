...
def main():
    #
    print(50*'-')
    print("Enter sample_matter_setupMicroEsym_mb.py:")
    print(50*'-')
    #
    # Print the many-body models available:
    #
    mbs, mbs_lower = nuda.matter.micro_esym_mbs()
    ...
    # select the models balonging to this mb
    #
    models, models_lower = nuda.matter.micro_esym_models_mbs( mbs )
    #
    print('for mbs:',mbs)
    print('models:',models)
    #
    ...
    #
    print(50*'-')
    print("Exit sample_matter_setupMicroEsym_mb.py:")
    print(50*'-')
    #
