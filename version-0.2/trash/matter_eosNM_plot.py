...
def main():
    #
    print(50*'-')
    print("Enter matter_eosNM_plot.py:")
    print(50*'-')
    #
    ...
    # plot pressure
    #
    pname = 'figs/plot_matter_eosNM.png'
    nuda.fig.matter_eosNM_fig( pname, micro_mbs, pheno_models, band )
    #
    print(50*'-')
    print("Exit matter_eosNM_plot.py:")
    print(50*'-')
    #
