...
def main():
    #
    print(50*'-')
    print("Enter matter_cs2NM_plot.py:")
    print(50*'-')
    #
    ...
    # plot pressure
    #
    pname = 'figs/plot_matter_cs2NM.png'
    nuda.fig.matter_cs2NM_fig( pname, micro_mbs, pheno_models, band )
    #
    print(50*'-')
    print("Exit matter_cs2NM_plot.py:")
    print(50*'-')
    #
