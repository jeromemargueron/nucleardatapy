...
def main():
    #
    print(50*'-')
    print("Enter matter_eosSM_plot.py:")
    print(50*'-')
    #
    ...
    # plot pressure
    #
    pname = 'figs/plot_matter_eosSM.png'
    nuda.fig.matter_eosSM_fig( pname, micro_mbs, pheno_models, band )
    #
    print(50*'-')
    print("Exit matter_eosSM_plot.py:")
    print(50*'-')
    #
