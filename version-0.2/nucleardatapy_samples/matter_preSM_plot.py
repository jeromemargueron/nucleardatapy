...
def main():
    #
    print(50*'-')
    print("Enter matter_preSM_plot.py:")
    print(50*'-')
    #
    ...
    # plot pressure
    #
    pname = 'figs/plot_matter_preSM.png'
    nuda.fig.matter_preSM_fig( pname, micro_mbs, pheno_models, band )
    #
    print(50*'-')
    print("Exit matter_preSM_plot.py:")
    print(50*'-')
    #
