...
def main():
    ...
    nuda.plot.matter_setupMicro_band_fig( pname, models, den=den, matter='NM' )
    #
    # plot E/A + band for SM
    #
    models = [ '2016-MBPT-AM', '2020-MBPT-AM' ]
    pname = 'figs/plot_matter_setupMicroBand_SM.png'
    nuda.plot.matter_setupMicro_band_fig( pname, models, den=den, matter='SM' )
    #
    # plot Esym + band for SM
    #
    models = [ '2016-MBPT-AM', '2020-MBPT-AM' ]
    pname = 'figs/plot_matter_setupMicroBand_Esym.png'
    nuda.plot.matter_setupMicro_band_fig( pname, models, den=den, matter='ESYM' )
    #
    print(50*'-')
