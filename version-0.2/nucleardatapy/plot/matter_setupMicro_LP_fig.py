    ...
    #
    	...
    	if matter in model:
    		...
    		if mic.err:
    			...
    			if matter.lower() == 'sm' and mic.sm_kfn is not None:
    				axs[0,0].scatter( mic.sm_kfn, mic.sm_LP['F'][ell], marker=mic.marker, linestyle=mic.linestyle, label=mic.label )
    				axs[0,1].scatter( mic.sm_kfn, mic.sm_LP['G'][ell], marker=mic.marker, linestyle=mic.linestyle, label=mic.label )
    				axs[1,0].scatter( mic.sm_kfn, mic.sm_LP['Fp'][ell], marker=mic.marker, linestyle=mic.linestyle, label=mic.label )
    				axs[1,1].scatter( mic.sm_kfn, mic.sm_LP['Gp'][ell], marker=mic.marker, linestyle=mic.linestyle, label=mic.label )
    			elif matter.lower() == 'nm' and mic.nm_kfn is not None:
    				axs[0].scatter( mic.nm_kfn, mic.nm_LP['F'][ell], marker=mic.marker, linestyle=mic.linestyle, label=mic.label )
    				axs[1].scatter( mic.nm_kfn, mic.nm_LP['G'][ell], marker=mic.marker, linestyle=mic.linestyle, label=mic.label )
    	#
