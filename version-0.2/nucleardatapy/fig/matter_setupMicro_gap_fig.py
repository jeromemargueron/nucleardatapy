        ...
        if matter.lower() == "nm":
            if gap.nm_gap_1s0 is not None:
                if gap.nm_gap_1s0_err is not None:
                    ...
                    axs[1, 0].errorbar(
                        gap.nm_den_1s0,
                        gap.nm_gap_1s0 / nuda.eF_n(gap.nm_kfn_1s0),
                        yerr=gap.nm_gap_1s0_err / nuda.eF_n(gap.nm_kfn_1s0),
                        marker=gap.marker,
                        markevery=gap.every,
                        linestyle="none",
                    )
            ...
            if gap.sm_gap_1s0 is not None:
                if gap.sm_gap_1s0_err is not None:
                    ...
                    axs[1, 0].errorbar(
                        gap.sm_den_1s0,
                        gap.sm_gap_1s0 / nuda.eF_n(gap.sm_kfn_1s0),
                        yerr=gap.sm_gap_1s0_err / nuda.eF_n(gap.sm_kfn_1s0),
                        marker=gap.marker,
                        markevery=gap.every,
                        linestyle="none",
                    )
