...
def eos_setupAM_e_asy_nuc_fig( pname, models_micro, models_pheno, asy ):
    """
    ...
    for model in models_micro:
        ...
        if micro.esym is not None: 
            ...
            axs[0].plot( micro.den, micro.e2a_nuc, marker='o', linestyle=micro.linestyle, label=micro.label, markevery=micro.every )
    ...
    for model in models_pheno:
        ...
        for param in params:
            ...
            if pheno.esym is not None: 
                ...
                #beta.label=None
                axs[1].plot( pheno.den, pheno.e2a_nuc, linestyle=pheno.linestyle, label=pheno.label, markevery=pheno.every )
