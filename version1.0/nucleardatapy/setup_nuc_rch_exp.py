...
def nuc_rch_exp_tables():
    ...
    #
    if nuda.env.verb: print("Exit nuc_rch_exp_tables()")
    #
    return tables, tables_lower

class SetupNucRchExp():
   """
   ...
   **Attributes:**
   ...
   def __init__( self, table = '2013-Angeli' ):
      ...
      self.nucRch_err = []
      #
      tables, tables_lower = nuc_rch_exp_tables()
      #
