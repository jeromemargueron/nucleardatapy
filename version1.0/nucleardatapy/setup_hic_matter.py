...
class SetupHICMatter():
    ...
    **Attributes:**
    ...
    def __init__(self, constraint = 'DLL-2002'):
        #
        if nuda.env.verb: print("Enter SetupHICMatter()")
        #
        self.constraint = constraint
        if nuda.env.verb: print("constraint:",constraint)
        #
        self = SetupHICMatter.init_self( self )
        #
        constraints, constraints_lower = constraints_HIC_matter()
