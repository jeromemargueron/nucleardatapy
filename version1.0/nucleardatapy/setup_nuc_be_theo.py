...
def nuc_be_theo_tables():
    ...
    #
    if nuda.env.verb: print("Exit nuc_be_theo_tables()")
    #
    return tables, tables_lower

class SetupNucBETheo():
    """
    ...
    **Attributes:**
    ...
    def __init__(self, table = '1995-DZ' ):
        #
        if nuda.env.verb: print("Enter SetupNucBETheo()")
        #
        tables, tables_lower = nuc_be_theo_tables()
        ...
        #
        self = SetupNucBETheo.init_self( self )
        #
    ...
    def diff(self, table, Zref = 50 ):
        ...
        **Attributes:**
        ...
        # table
        #
        mod = nuda.SetupNucBETheo( table = table )
        BE_mod = []
        N_mod = []
        A_mod = []
    ...
    def diff_exp(self, table_exp, version_exp, Zref = 50 ):
        ...
        **Attributes:**
        ...
        # table
        #
        exp = nuda.SetupNucBEExp( table = table_exp, version = version_exp )
