...
class SetupEOSMicroBand():
    ...
    **Attributes:**
    ...
    def __init__( self, models = [ '2016-MBPT-AM' ], nden = 10, ne = 200, den=None, matter='NM', e2a_min = -20.0, e2a_max = 50.0 ):
        ...
        """
        #
        if nuda.env.verb: print("Enter SetupEOSMicroBand()")
        #
        if matter.lower() == 'nm':
            print('\nBand in NM')
            ...
            print('\nBand for Esym')
        #
        self = SetupEOSMicroBand.init_self( self )
        #
        #: Attribute model.
        self.models = models
        ...
        #
        modelsref, modelsref_lower = nuda.eos_micro_models()
        for model in models:
        ...
        #
        if nuda.env.verb: print("Exit SetupEOSMicroBand()")
        #
