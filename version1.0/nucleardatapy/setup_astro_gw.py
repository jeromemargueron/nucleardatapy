...
def astro_gw():
    ...
    #
    if nuda.env.verb: print("Exit astro_gw()")
    #
    return sources, sources_lower

def astro_gw_source( source ):
    """
    ...
    #
    if nuda.env.verb: print("Exit astro_gw_source()")
    #
    return hyps
...
class SetupAstroGW():
    ...
    **Attributes:**
    ...
    def __init__(self, source = 'GW170817', hyp = 1 ):
        ...
        #
        hyps = astro_gw_source( source = source )
        if hyp not in hyps:
...
class SetupAstroGWAverage():
    ...
    **Attributes:**
    ...
    def __init__(self, source = 'GW170817' ):
        #
        if nuda.env.verb: print("Enter SetupAstroGWAverage()")
        #
        self.source = source
        self.latexCite = None
        self.ref = None
