...
def nuc_be_exp_tables():
    ...
    #
    if nuda.env.verb: print("Exit nuc_be_exp_tables()")
    #
    return tables, tables_lower

def nuc_be_exp_versions( table ):
    """
    ...
    #
    if nuda.env.verb: print("Exit nuc_be_exp_tables_versions()")
    #
...
class SetupNucBEExp():
    ...
    **Attributes:**
    ...
    def __init__(self, table = 'AME', version = '2020'):
        #
        if nuda.env.verb: print("Enter SetupNucBEExp()")
        #
        tables, tables_lower = nuc_be_exp_tables()
        ...
        #
        versions, versions_lower = nuc_be_exp_versions( table = table )
