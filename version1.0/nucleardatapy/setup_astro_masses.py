...
def astro_masses():
    ...
    #
    if nuda.env.verb: print("Exit astro_masses()")
    #
    return sources, sources_lower

def astro_masses_source( source ):
    """
    ...
    #
    if nuda.env.verb: print("Exit astro_masses_source()")
    #
    return obss

class SetupAstroMasses():
    """
    ...
    **Attributes:**
    ...
    def __init__(self, source = 'J1614–2230', obs = 1 ):
        ...
        #
        obss = astro_masses_source( source = source )
        if obs not in obss:
...
class SetupAstroMassesAverage():
    ...
    **Attributes:**
    ...
    def __init__(self, source = 'J1614–2230' ):
        #
        if nuda.env.verb: print("Enter SetupAstroMassesAverage()")
        #
        self.source = source
        self.latexCite = None
        self.ref = None
