...
class SetupEOSMicroLP():
    ...
    **Attributes:**
    ...
    def __init__( self, model = '1994-BHF-SM-LP-AV14-GAP' ):
        ...
        """
        #
        if nuda.env.verb: print("Enter SetupEOSMicroLP()")
        #
        #: Attribute model.
        self.model = model
        if nuda.env.verb: print("model:",model)
        #
        self = SetupEOSMicroLP.init_self( self )
        #
        models, models_lower = eos_micro_LP_models()
        #
        ...
        self.Ksat_unit = 'MeV'
        #
        if nuda.env.verb: print("Exit SetupEOSMicroLP()")
        #
