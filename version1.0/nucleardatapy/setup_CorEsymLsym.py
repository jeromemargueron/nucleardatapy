...
class SetupCorEsymLsym():
    ...
    **Attributes:**
    ...
    def __init__( self, constraint = '2014-IAS' ):
        #
        if nuda.env.verb: print("Enter SetupCorEsymLsym()")
        ...
        self.alpha = 0.5
        #
        constraints, constraints_lower = CorEsymLsym_constraints()
        #
    ...
    #print('np.arrange2:',np.arange(len(aEsym)-1,0,-1))
        ...
        if nuda.env.verb: print("Exit SetupCorEsymLsym()")
    #
