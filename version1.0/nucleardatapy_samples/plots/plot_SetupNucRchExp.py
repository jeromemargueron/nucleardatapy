...
def plot_SetupNucRchExp( pname, tables ):
    #
    # plot
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_SetupNucRchExp.py:")
    print(50*'-')
    #
    ...
    #
    pname = 'figs/plot_SetupNucRchExp.png'
    #
    plot_SetupNucRchExp( pname, tables )
    #
    print(50*'-')
    print("Exit plot_SetupNucRchExp.py:")
    print(50*'-')
    #
