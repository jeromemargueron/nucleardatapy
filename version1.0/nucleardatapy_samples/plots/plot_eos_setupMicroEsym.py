...
def plot_eos_setupMicroEsym( pname, models ):
    #
    ...
    for model in models:
        ...
        if esym.esym is not None:
            if esym.esym_err is not None:
                ...
                axs[0,0].plot( esym.den, esym.esym, marker=esym.marker, linestyle='none', label=esym.label )
                axs[0,1].plot( esym.kf,  esym.esym, marker=esym.marker, linestyle='none', label=esym.label )
                axs[1,0].plot( esym.den, esym.esym/nuda.esymffg(esym.kf), marker=esym.marker, linestyle='none', label=esym.label )
                axs[1,1].plot( esym.kf,  esym.esym/nuda.esymffg(esym.kf), marker=esym.marker, linestyle='none', label=esym.label )
...
def main():
    ...
    #
    plot_eos_setupMicroEsym( pname, models )
    #
    print(50*'-')
