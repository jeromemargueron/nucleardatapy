...
def plot_eos_cs2( pname, micro_models, pheno_models, band ):
    #
    # plot pre in NM
    #
...
def main():
    ...
    band = nuda.eos.setupMicroBand( models, den=den, matter='NM' )
    #
    ...
    # plot Esym
    #
    pname = 'figs/plot_eos_cs2.png'
    plot_eos_cs2( pname, micro_models, pheno_models, band )
    #
    print(50*'-')
    print("Exit plot_eos_cs2.py:")
    print(50*'-')
    #
