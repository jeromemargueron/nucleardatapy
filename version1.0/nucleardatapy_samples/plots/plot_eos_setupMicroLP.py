...
def plot_eos_setupMicroLP0_SM( pname, models ):
    #
...
def plot_eos_setupMicroLP1_SM( pname, models ):
    #
    # plot Landau Parameters in SM
    #
    print(f'Plot name: {pname}')
...
def main():
    #
    print(50*'-')
    print("Enter plot_eos_setupMicroLP.py:")
    print(50*'-')
    #
    ...
    #
    pname = 'figs/plot_eos_setupMicroLP0_SM.png'
    #
    print('pname:',pname)
    plot_eos_setupMicroLP0_SM( pname, models )
    #
    # plot Landau Parameters L=1 in SM
    #
    pname = 'figs/plot_eos_setupMicroLP1_SM.png'
    #
    print('pname:',pname)
    plot_eos_setupMicroLP1_SM( pname, models )
    #
    print(50*'-')
    print("Exit plot_eos_setupMicroLP.py:")
    print(50*'-')
    #
