...
def plot_SetupEOSMicro_nm_gap( pname, models ):
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_SetupEOSMicroGap.py:")
    print(50*'-')
    #
    ...
    #
    pname = 'figs/plot_SetupEOSMicro_gap_NM.png'
    #
    plot_SetupEOSMicro_nm_gap( pname, models )
    #
    print(50*'-')
    print("Exit plot_SetupEOSMicroGap.py:")
    print(50*'-')
    #
