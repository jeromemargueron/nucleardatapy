...
def plot_setupEOSMicroLP0_SM( pname, models ):
    #
...
def plot_setupEOSMicroLP1_SM( pname, models ):
    #
    # plot Landau Parameters in SM
    #
    print(f'Plot name: {pname}')
...
def main():
    #
    print(50*'-')
    print("Enter plot_SetupEOSMicroLP.py:")
    print(50*'-')
    #
    ...
    #
    pname = 'figs/plot_SetupEOSMicroLP0_SM.png'
    #
    print('pname:',pname)
    plot_setupEOSMicroLP0_SM( pname, models )
    #
    # plot Landau Parameters L=1 in SM
    #
    pname = 'figs/plot_SetupEOSMicroLP1_SM.png'
    #
    print('pname:',pname)
    plot_setupEOSMicroLP1_SM( pname, models )
    #
    print(50*'-')
    print("Exit plot_SetupEOSMicroLP.py:")
    print(50*'-')
    #
