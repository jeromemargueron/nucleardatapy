...
def plot_nuc_setupBEExp_chart( pname, table, version ):
    #
    print(50*'-')
    print("Enter plot_nuc_setupBEExp_chart.py:")
    print(50*'-')
    #
    print('Table:',table)
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_nuc_setupBEExp.py:")
    print(50*'-')
    #
    ...
    for i,table in enumerate( tables ):
        ...
        version = versions[i]
        # plot nuclear chart:
        pname = 'figs/plot_nuc_setupBEExp_'+table+'_'+version+'.png'
        print(f'Plot name: {pname}')
        plot_nuc_setupBEExp_chart( pname, table, version )
        #
        # plot discovery years:
        pname = 'figs/plot_nuc_setupBEExp_'+table+'_'+version+'_year.png'
        print(f'Plot name: {pname}')
        plot_nuc_setupBEExp_year( pname, table, version )
    #
    print(50*'-')
    print("Exit plot_nuc_setupBEExp.py:")
    print(50*'-')
    #
