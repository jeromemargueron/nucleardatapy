...
def plot_SetupEOSPheno_E( models, band, matter ):
    #
    for model in models:
        #
        # plot name:
        #
        pname = 'figs/plot_SetupEOSPheno-'+model+'-E-'+matter+'.png'
...
def main():
    #
    print(50*'-')
    print("Enter plot_SetupEOSPheno_E.py:")
    print(50*'-')
    #
    ...
    bandNM = nuda.SetupEOSMicroBand( bmodels, den=den, matter='NM' )
    #
    bmodels = [ '2016-MBPT-AM', '2020-MBPT-AM' ]
    bandSM = nuda.SetupEOSMicroBand( bmodels, den=den, matter='SM' )
    #
    ...
    #
    matter='NM'
    plot_SetupEOSPheno_E( models, bandNM, matter )
    #
    # plot E/A in SM
    #
    matter='SM'
    plot_SetupEOSPheno_E( models, bandSM, matter )
    #
    print(50*'-')
    print("Exit plot_SetupEOSPheno_E.py:")
    print(50*'-')
    #
