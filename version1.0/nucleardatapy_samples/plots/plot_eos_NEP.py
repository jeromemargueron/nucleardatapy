...
def plot_eos_NEP( pname, models_micro, models_pheno ):
    #
...
def main():
    ...
    #
    pname = 'figs/plot_eos_NEP.png'
    plot_eos_NEP( pname, micro_models, pheno_models )
    #
    print(50*'-')
    print("Exit plot_eos_NEP.py:")
    print(50*'-')
    #
