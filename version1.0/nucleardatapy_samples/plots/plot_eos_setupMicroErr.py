...
def plot_eos_setupMicroErr( pname, models ):
    #
    # plot err/e in NM
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_eos_setupMicroErr.py:")
    print(50*'-')
    #
    ...
    # plot errors in NM
    #
    pname = 'figs/plot_eos_setupMicro_NM_err.png'
    plot_eos_setupMicroErr( pname, models )
    #
    print(50*'-')
    print("Exit plot_eos_setupMicroErr.py:")
    print(50*'-')
    #
