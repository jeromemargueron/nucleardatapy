...
def main():
    #
    print(50*'-')
    print("Enter plot_SetupEOSFFG.py:")
    print(50*'-')
    #
    ...
    # plot E/E_FFG in NM
    #
    pname = 'figs/plot_SetupEOSFFG.png'
    ...
    #
    ffg0 = nuda.SetupEOSFFG( den, delta0 )
    ffg1 = nuda.SetupEOSFFG( den, delta1 )
    if any(ffg0.e2a_int): 
    ...
    #
    print(50*'-')
    print("Exit plot_SetupEOSFFG.py:")
    print(50*'-')
    #
