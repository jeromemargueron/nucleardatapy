...
def plot_eos_setupMicroBand( pname, models, den, matter ):
    #
    # plot e in NM
    #
    ...
    for model in models:
        ...
        if mic.nm_e2a is not None: 
            ...
            if matter.lower() == 'nm':
                ...
                axs[1].errorbar( esym.den, esym.esym/nuda.esymffg(esym.kf), yerr= esym.esym_err/nuda.esymffg(esym.kf), linestyle=esym.linestyle, label=esym.label, errorevery=esym.every )
    #
    band = nuda.eos.setupMicroBand( models, den=den, matter=matter )
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_eos_setupMicroBand.py:")
    print(50*'-')
    #
    ...
    pname = 'figs/plot_eos_setupMicroBand_NM.png'
    plot_eos_setupMicroBand( pname, models, den=den, matter='NM' )
    #
    # plot E/A + band for SM
    #
    models = [ '2016-MBPT-AM', '2020-MBPT-AM' ]
    pname = 'figs/plot_eos_setupMicroBand_SM.png'
    plot_eos_setupMicroBand( pname, models, den=den, matter='SM' )
    #
    # plot Esym + band for SM
    #
    models = [ '2016-MBPT-AM', '2020-MBPT-AM' ]
    pname = 'figs/plot_eos_setupMicroBand_Esym.png'
    plot_eos_setupMicroBand( pname, models, den=den, matter='ESYM' )
    #
    print(50*'-')
    print("Exit plot_eos_setupMicroBand.py:")
    print(50*'-')
    #
