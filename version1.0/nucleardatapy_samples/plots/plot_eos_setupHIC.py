...
def plot_eos_setupHIC( pname, constraints ):
    #
    # plot
    #
    ...
    axs[1][0].set_ylabel(r'$e_\mathrm{SM}$ (MeV)',fontsize='12')
    ...
    axs[0][1].set_ylabel(r'$p_\mathrm{NM}$ (MeV fm$^{-3}$)',fontsize='12')
...
def main():
    #
    print(50*'-')
    print("Enter plot_eos_setupHIC.py:")
    print(50*'-')
    #
    ...
    #
    constraints, constraints_lower = nuda.hic_constraints()
   
    #constraints = [ '2014-IAS' ]
    #
    pname = 'figs/plot_eos_setupHIC.png'
    #
    plot_eos_setupHIC( pname, constraints )
    #
    print(50*'-')
    print("Exit plot_eos_setupHIC.py:")
    print(50*'-')
    #
