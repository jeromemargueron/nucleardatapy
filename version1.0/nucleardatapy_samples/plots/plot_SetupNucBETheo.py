...
def plot_SetupNucBETheo_isotopes( tables, table_ref = '1995-DZ', Zref = 50 ):
    #
    print(50*'-')
    print("Enter plot_SetupNucBETheo_isotopes.py:")
    print(50*'-')
    #
    print('Tables:',tables)
    ...
    print('Zref:',Zref)
    #
    pname = 'figs/plot_SetupNucBETheo_Zref'+str(Zref)+'.png'
    ...
    #
    mas = nuda.SetupNucBETheo( table = table_ref )
    #
    ...
    #
    print(50*'-')
    print("Exit plot_SetupNucBETheo_isotopes.py:")
    print(50*'-')
...
def plot_theory_isotopes_old( tables, table_ref = '1995-DZ', Zref = 50 ):
    #
    print(50*'-')
    print("Enter plot_SetupNucBETheo_isotopes_old.py:")
    print(50*'-')
    #
    print('Tables:',tables)
    if table_ref in tables:
    ...
    pname = 'figs/plot_SetupNucBETheo_Zref'+str(Zref)+'.png'
    print(f'Plot name: {pname}')
    mas_ref = nuda.SetupNucBETheo( table = table_ref )
    BE_ref = []
    N_ref = []
    ...
    for i,table in enumerate( tables ):
        #
        mas = nuda.SetupNucBETheo( table = table )
    ...
    #
    print(50*'-')
    print("Exit plot_SetupNucBETheo_isotopes_old.py:")
    print(50*'-')

def main():
    #
    print(50*'-')
    print("Enter plot_SetupNucBETheo.py:")
    print(50*'-')
    #
    ...
    #
    tables, tables_lower = nuda.nuc_be_theo_tables()
    #tables = [ '1995-DZ' ]
    #
    plot_SetupNucBETheo_isotopes( tables, Zref = 50 )
    #
    plot_SetupNucBETheo_isotopes( tables, Zref = 20 )
    #
    print(50*'-')
    print("Exit plot_SetupNucBETheo.py:")
    print(50*'-')
    #
