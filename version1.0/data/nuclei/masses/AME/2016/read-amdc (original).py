...
#            nucBE = ( nucMass - nucZ * ( CST_mpc2 + CST_mec2 ) - nucN * CST_mnc2 )
            nucBE = nucME / 1000.0 - nucZ * 7.2889706 - nucN * 8.0713171
            nucdBE = nucdMass
            if ( nucA == 16 and nucZ == 8 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
#                print(line)
            if ( nucA == 34 and nucZ == 14 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
            if ( nucA == 40 and nucZ == 20 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
            if ( nucA == 48 and nucZ == 20 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
            if ( nucA == 52 and nucZ == 20 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
            if ( nucA == 54 and nucZ == 20 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
            if ( nucA == 48 and nucZ == 28 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
            if ( nucA == 56 and nucZ == 28 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
            if ( nucA == 78 and nucZ == 28 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
            if ( nucA == 90 and nucZ == 40 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
            if ( nucA == 100 and nucZ == 50 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
            if ( nucA == 132 and nucZ == 50 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
            if ( nucA == 208 and nucZ == 82 ):
                print('A:'+str(nucA)+',Z:'+str(nucZ)+',nucl:'+nucName+',BE:'+str(nucBE)+',dBE:'+str(nucdBE))
            yearInt=int(yearStr)
