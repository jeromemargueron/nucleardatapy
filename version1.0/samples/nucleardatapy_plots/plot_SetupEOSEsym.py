...
def plot_SetupEOSEsym( pname, constraints, Ksym ):
    #
    # plot
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_SetupEsymDen.py:")
    print(50*'-')
    #
    ...
    for Ksym in Ksyms:
        #
        pname = 'figs/plot_SetupEOSEsym_'+str(int(Ksym))+'.png'
        #
        plot_SetupEOSEsym( pname, constraints, Ksym )
    #
    print(50*'-')
    print("Exit plot_SetupEOSEsym.py:")
    print(50*'-')
    #
