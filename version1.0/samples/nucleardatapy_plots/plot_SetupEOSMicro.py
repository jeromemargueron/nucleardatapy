...
def plot_setupEOSMicro_nm_e2a( pname, group, models, band ):
    #
    # plot E/A in NM
    #
    ...
    for model in models:
        #
        mic = nuda.SetupEOSMicro( model = model, var2=1.0 )
        print('\nmodel:',model,'\n')
...
def plot_setupEOSMicro_sm_e2a( pname, group, models, band ):
    #
    # plot E/A in SM
    #
    print(f'Plot name: {pname}')
    ...
    for model in models:
        #
        mic = nuda.SetupEOSMicro( model = model, var2=0.0 )
        print('\nmodel:',model,'\n')
...
def main():
    #
    print(50*'-')
    print("Enter plot_SetupEOSMicro.py:")
    print(50*'-')
    #
    ...
    #
    band = nuda.SetupEOSMicroBand( bmodels )
    #
    ...
    for i,group in enumerate(groups):
        ...
        #
        pname = 'figs/plot_SetupEOSMicro_e2a_NM_'+group+'.png'
        print('pname:',pname)
        #
        # list the available models in groups
        #
        models, models_lower = nuda.eos_micro_models_group_NM( group )
        #
        print('models:',models)
        plot_setupEOSMicro_nm_e2a( pname, group, models, band )
        #
    #
    # ===============================
    # Symmetric Matter (SM)
    ...
    #
    band = nuda.SetupEOSMicroBand( bmodels, matter='SM' )
    #
    # create the groups for the figures
    #
    groups = [ 'VAR', 'AFDMC', 'BHF', 'QMC', 'MBPT', 'NLEFT' ]
    ...
    for i,group in enumerate(groups):
        ...
        # list the available models in groups
        #
        models, models_lower = nuda.eos_micro_models_group_SM( group )
        #
        print('models:',models)
        #
        plot_setupEOSMicro_sm_e2a( pname, group, models, band )
        #
    #
    print(50*'-')
    print("Exit plot_SetupEOSMicro.py:")
    print(50*'-')
    #
