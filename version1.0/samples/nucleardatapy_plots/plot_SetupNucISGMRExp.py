...
def plot_SetupNucISGMRExp( pname, tables ):
    #
    # plot
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_SetupNucISGMRExp.py:")
    print(50*'-')
    #
    ...
    #
    pname = 'figs/plot_SetupNucISGMRExp.png'
    #
    plot_SetupNucISGMRExp( pname, tables )
    #
    print(50*'-')
    print("Exit plot_SetupNucISGMRExp.py:")
    print(50*'-')
    #
