...
def plot_astro_mtov( pname, sources_do, sources_up ):
    #
    # plot
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_SetupAstroMtov.py:")
    print(50*'-')
    #
    ...
    # plot the results:
    #
    pname = 'figs/plot_SetupAstroMtov.png'
    plot_astro_mtov( pname, sources_do, sources_up )
    #
    print(50*'-')
    print("Exit plot_SetupAstroMtov.py:")
    print(50*'-')
    #
