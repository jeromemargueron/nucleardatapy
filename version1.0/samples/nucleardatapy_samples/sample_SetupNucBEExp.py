...
def main():
    #
    print(50*'-')
    print("Enter sample_SetupNucBEExp.py:")
    print(50*'-')
    #
    tables = [ 'AME' ]
    #tables, tables_lower = nuda.nuc_be_tables()
    #
    for table in tables:
        #
        # Search for GS and unstable nuclei in the 'AME' '2020'
        #
        mas = nuda.SetupNucBEExp( table = table, version = '2020' )
        print('\nFrom mass table')
        #print('A:',mas.A)
    ...
    #
    print(50*'-')
    print("Exit sample_SetupNucBEExp.py:")
    print(50*'-')
    #
