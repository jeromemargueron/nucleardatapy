...
class SetupPhenoMatter():
    ...
    **Attributes:**
    ...
    def __init__( self, model = 'Skyrme', param = 'SLY5' ):
        ...
        #
        models, models_lower = models_pheno_matter( )
        #
        if model.lower() not in models_lower:
            ...
            exit()
        #
        params, params_lower = params_pheno_matter( model = model )
        #
...
#            pass
        ...
        self.gap_unit = 'MeV'
        #
        if nuda.env.verb: print("Exit SetupPhenoMatter()")
    #
