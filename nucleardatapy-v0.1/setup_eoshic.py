...
def constraints_EOSHIC():
    ...
    #
    if nuda.env.verb: print("Exit constraints_HIC()")
    #
...
class SetupEOSHIC():
    ...
    **Attributes:**
    ...
    def __init__(self, constraint = 'DLL-2002'):
        ...
        #
        constraints, constraints_lower = constraints_EOSHIC()
        ...
        if constraint.lower()=='dll-2002':
            #
            file_in1 = nuda.param.path_data+'eos/hic/2002-DLL-SM.dat'
            file_in2 = nuda.param.path_data+'eos/hic/2002-DLL-NM-soft.dat'
            file_in3 = nuda.param.path_data+'eos/hic/2002-DLL-NM-stiff.dat'
            ...
            #
            file_in = nuda.param.path_data+'eos/hic/2016-FOPI.dat'
