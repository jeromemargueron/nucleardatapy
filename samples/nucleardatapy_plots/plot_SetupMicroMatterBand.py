...
def plot_matterband( pname, models, den, matter ):
    #
    # plot e in NM
    #
    ...
    #
    band = nuda.SetupMicroMatterBand( models, den=den, matter=matter )
    #
...
def main():
    #
    print(50*'-')
    print("Enter plot_SetupMicroMatterBand.py:")
    print(50*'-')
    #
    ...
    pname = 'figs/plot_SetupMicroMatterBand_NM.png'
    plot_matterband( pname, models, den=den, matter='NM' )
    #
    # plot E/A + band for SM
    #
    models = [ '2016-MBPT-AM', '2020-MBPT-AM' ]
    pname = 'figs/plot_SetupMicroMatterBand_SM.png'
    plot_matterband( pname, models, den=den, matter='SM' )
    #
    # plot Esym + band for SM
    #
    models = [ '2016-MBPT-AM', '2020-MBPT-AM' ]
    pname = 'figs/plot_SetupMicroMatterBand_Esym.png'
    plot_matterband( pname, models, den=den, matter='ESYM' )
    #
    print(50*'-')
    print("Exit plot_SetupMicroMatterBand.py:")
    print(50*'-')
    #
