...
def plot_SetupRadCh( pname, tables ):
    #
    # plot
    #
    ...
    for table in tables:
        ...
        Zref = 40
        print('For Zref:',Zref)
        Nref, Aref, Rchref, Rchref_err = rch.RadCh_isotopes( Zref = Zref )
        print('Nref:',Nref)
        print('Aref:',Aref)
        print('Rchref:',Rchref)
...
def main():
    #
    print(50*'-')
    print("Enter plot_SetupRadCh.py:")
    print(50*'-')
    #
    ...
    #
    pname = 'figs/plot_SetupRadCh.png'
    #
    plot_SetupRadCh( pname, tables )
    #
    print(50*'-')
    print("Exit plot_SetupRadCh.py:")
    print(50*'-')
    #
