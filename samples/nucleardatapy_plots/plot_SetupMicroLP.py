...
def plotMicroLP0_SM( pname, models ):
    #
...
def plotMicroLP1_SM( pname, models ):
    #
    # plot Landau Parameters in SM
    #
    print(f'Plot name: {pname}')
...
def main():
    #
    print(50*'-')
    print("Enter plot_SetupMicroLP.py:")
    print(50*'-')
    #
    ...
    #
    pname = 'figs/plot_SetupMicroLP0_SM.png'
    #
    print('pname:',pname)
    plotMicroLP0_SM( pname, models )
    #
    # plot Landau Parameters L=1 in SM
    #
    pname = 'figs/plot_SetupMicroLP1_SM.png'
    #
    print('pname:',pname)
    plotMicroLP1_SM( pname, models )
    #
    print(50*'-')
    print("Exit plot_SetupMicroLP.py:")
    print(50*'-')
    #
