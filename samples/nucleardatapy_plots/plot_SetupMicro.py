...
def main():
    ...
    for model in models:
        ...
        if any(mic.nm_e2a): 
            ...
            axs[0,1].plot( mic.nm_kfn, mic.nm_e2a/nuda.epsF_n(mic.nm_kfn), linestyle='solid', label=mic.label )
    ...
    for model in models:
        ...
        if any(mic.nm_gap): 
            ...
            axs[0,1].plot( mic.nm_kfn, mic.nm_gap/nuda.epsF_n(mic.nm_kfn), linestyle='solid', label=mic.label )
