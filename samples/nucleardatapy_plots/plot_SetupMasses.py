...
def plot_nuclear_chart( pname, table, version ):
    #
    print(50*'-')
    print("Enter plot_nuclear_chart.py:")
    print(50*'-')
    #
    print('Table:',table)
    #
    ...
    #
    print(50*'-')
    print("Exit plot_nuclear_chart.py:")
    print(50*'-')

def plot_histo_year( pname, table, version ):
    #
    print(50*'-')
    print("Enter plot_histo_year.py:")
    print(50*'-')
    #
    print('Table:',table)
    #
