...
.. figure:: ../../../version-1.0/nucleardatapy_samples/figs/plot_matter_setupMicro_e2a_NM_VAR.png
	:width: 70%
...
.. figure:: ../../../version-1.0/nucleardatapy_samples/figs/plot_matter_setupMicro_e2a_NM_AFDMC.png
	:width: 70%
	:alt: map to buried treasure
...
.. figure:: ../../../version-1.0/nucleardatapy_samples/figs/plot_matter_setupMicro_e2a_NM_BHF2.png
	:width: 70%
	:alt: map to buried treasure

	This figure shows the energy in neutron matter (NM) over the
	free Fermi gas energy (top) and the energy per particle
	(bottom) as function of the density (left) and the neutron
	Fermi momentum (right) for the BHF models with 2BF only available in the nucleardatapy toolkit.

.. figure:: ../../../version-1.0/nucleardatapy_samples/figs/plot_matter_setupMicro_e2a_NM_BHF23.png
	:width: 70%
	:alt: map to buried treasure
	...
	free Fermi gas energy (top) and the energy per particle
	(bottom) as function of the density (left) and the neutron
	Fermi momentum (right) for the BHF models with 2 and 3BF available in the nucleardatapy toolkit.

.. figure:: ../../../version-1.0/nucleardatapy_samples/figs/plot_matter_setupMicro_e2a_NM_QMC.png
	:width: 70%
	:alt: map to buried treasure
...
.. figure:: ../../../version-1.0/nucleardatapy_samples/figs/plot_matter_setupMicro_e2a_NM_MBPT.png
	:width: 70%
	:alt: map to buried treasure
...
.. figure:: ../../../version-1.0/nucleardatapy_samples/figs/plot_matter_setupMicro_e2a_NM_SCGF.png
	:width: 70%
	:alt: map to buried treasure
...
.. figure:: ../../../version-1.0/nucleardatapy_samples/figs/plot_matter_setupMicro_e2a_NM_CC.png
	:width: 70%
	:alt: map to buried treasure
